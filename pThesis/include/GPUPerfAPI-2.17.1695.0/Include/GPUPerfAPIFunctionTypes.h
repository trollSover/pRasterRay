...
// Mantle APIs -- these are currently only supported by the Mantle version of GPUPerfAPI
typedef GPA_Status(*GPA_GetMemoryRefsPtrType)(gpa_uint32* numRefs, void*& memRefs);
